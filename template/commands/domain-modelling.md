---
description: Extract strategic DDD patterns — ubiquitous language, bounded contexts, subdomains, and a context map — from curated transcripts and HTML mockups into output/domain-analysis.md.
argument-hint: (no arguments — reads output/transcripts/*_curated.txt and output/html/**/*.html, writes output/domain-analysis.md)
---
